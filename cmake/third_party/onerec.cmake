...
set(ONEREC_HEADERS
        "${ONEREC_BASE_DIR}/cpp/onerec/include/onerec_generated.h"
        )
...
if (THIRD_PARTY)
    ...
    add_custom_target(onerec_create_header_dir
            COMMAND ${CMAKE_COMMAND} -E make_directory ${ONEREC_INCLUDE_DIR}
            DEPENDS onerec)
    ...
    foreach (header_file ${ONEREC_HEADERS})
        add_custom_command(TARGET onerec_copy_headers_to_destination PRE_BUILD
                COMMAND ${CMAKE_COMMAND} -E copy_if_different ${header_file} ${ONEREC_INCLUDE_DIR})
    endforeach ()
