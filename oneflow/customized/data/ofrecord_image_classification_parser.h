...
*/
#ifndef ONEFLOW_CUSTOMIZED_DATA_OFRECORD_IMAGE_CLASSIFICATION_PARSER_H_
#define ONEFLOW_CUSTOMIZED_DATA_OFRECORD_IMAGE_CLASSIFICATION_PARSER_H_
 ...
 public:
  ...
  void Parse(std::shared_ptr<LoadTargetPtrList> batch_data,
    ...
    for (int64_t i = 0; i < batch_data->size(); ++i) {
      ...
      image_buffers[i].CopyFrom(*instance->image);
      label_buffers[i].CopyFrom(*instance->label);
    }
  }
};
...
#endif  // ONEFLOW_CUSTOMIZED_DATA_OFRECORD_IMAGE_CLASSIFICATION_PARSER_H_
