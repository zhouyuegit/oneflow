...
void GenerateBackwardOpConf(
  ...
  if (DiffLbi4BnInOp("x") != nullptr) {
    ...
    where_x_grad_op.set_name(op.op_name() + "_grad");
    ...
    where_x_grad_op_conf->set_condition(GenLogicalBlobName("condition");
  ...
  if (DiffLbi4BnInOp("y") != nullptr) {
    ...
    where_y_grad_op.set_name(op.op_name() + "_grad");
    ...
    where_y_grad_op_conf->set_condition(GenLogicalBlobName("condition");
