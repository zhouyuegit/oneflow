...
class DataLoadKernel final : public KernelIf<DeviceType::kCPU> {
 ...
 private:
  void VirtualKernelInit() override {
    data_loader_.reset(new data::DataLoader(this->op_conf().data_load_conf(),
                                            this->kernel_conf().data_load_conf()));
  }
...
REGISTER_KERNEL_WITH_NOTHING(OperatorConf::kDataLoadConf, DataLoadKernel);
