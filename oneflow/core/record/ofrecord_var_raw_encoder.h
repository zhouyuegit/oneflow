#ifndef ONEFLOW_CORE_RECORD_OFRECORD_VAR_RAW_ENCODER_H_
#define ONEFLOW_CORE_RECORD_OFRECORD_VAR_RAW_ENCODER_H_
...
template<typename T>
class OFRecordEncoderImpl<EncodeCase::kVarRaw, T> final : public OFRecordEncoderIf {
 private:
