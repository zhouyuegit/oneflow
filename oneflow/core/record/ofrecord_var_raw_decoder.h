...
template<typename T>
class OFRecordDecoderImpl<EncodeCase::kVarRaw, T> final : public OFRecordDecoder<EncodeCase::kVarRaw, T> {
 private:
  int32_t GetInstanceAvailableElemCnt(const Feature&) const override;
